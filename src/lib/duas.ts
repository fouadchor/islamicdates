...
export const DUA_SECTIONS: DuaSection[] = [
  ...
  // ───────────────────────── 4. Daily supplications ─────────────────────────
  {
    ...
    items: [
      ...
      {
        ar: 'سُبْحَانَ الَّذِي سَخَّرَ لَنَا هَذَا وَمَا كُنَّا لَهُ مُقْرِنِينَ، وَإِنَّا إِلَى رَبِّنَا لَمُنْقَلِبُونَ. اللّهُمَّ إِنَّا نَسْأَلُكَ فِي سَفَرِنَا هَذَا الْبِرَّ وَالتَّقْوَى، وَمِنَ الْعَمَلِ مَا تَرْضَى. اللّهُمَّ هَوِّنْ عَلَيْنَا سَفَرَنَا هَذَا وَاطْوِ عَنَّا بُعْدَهُ، اللّهُمَّ أَنْتَ الصَّاحِبُ فِي السَّفَرِ، وَالْخَلِيفَةُ فِي الْأَهْلِ، اللّهُمَّ إِنِّي أَعُوذُ بِكَ مِنْ وَعْثَاءِ السَّفَرِ، وَكَآبَةِ الْمَنْظَرِ، وَسُوءِ الْمُنْقَلَبِ فِي الْمَالِ وَالْأَهْلِ',
        when: { ar: 'دعاء السفر — وعند الرجوع يزيد: آيِبُونَ تَائِبُونَ عَابِدُونَ لِرَبِّنَا حَامِدُونَ', en: 'The supplication for travel — on returning, add: “Āyibūna tāʾibūna ʿābidūna li-Rabbinā ḥāmidūn”', ur: 'سفر کی دعا — واپسی پر یہ اضافہ کریں: آیِبونَ تائِبونَ عابِدونَ لِرَبِّنا حامِدونَ' },
        src: { kind: 'hadith', books: ['muslim'] },
      },
      {
  ...
  // ───────────────────────── 7. Provision, repentance & ease ─────────────────────────
  {
    ...
    items: [
      ...
      {
        ar: 'اللَّهُمَّ إِنِّي أَعُوذُ بِكَ مِنَ الْكُفْرِ وَالْفَقْرِ، وَمِنْ عَذَابِ الْقَبْرِ',
        when: { ar: 'الاستعاذة من الكفر والفقر وعذاب القبر', en: 'Seeking refuge from disbelief, poverty & the punishment of the grave', ur: 'کفر، فقر اور عذابِ قبر سے پناہ' },
